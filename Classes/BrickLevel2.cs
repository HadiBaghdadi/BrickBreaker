...
{
    class BrickLevel2 : DrawableGameComponent
    {
        ...
        public BrickLevel2(Game game, GraphicsDevice graphics, SpriteBatch spriteBatch, int width, int height, int posX, int posY) : base(game)
        {
        ...
        public bool CheckBallCollisionLevel2(Ball ball)
        {
            if (x >= 0)
            {
